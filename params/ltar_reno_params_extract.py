...
# NOTES:
# bringing in coordinates from metadata file
# coordinates available for towers only, sampling was done 100 m around towers

# dask cluster location
cluster_loc = 'hpc'

# input path
inPATH = '../data/ground/ltar_reno_biomass.csv'
...
df_meta = pd.read_csv('../data/ground/ltar_reno_pasture_info.csv')
